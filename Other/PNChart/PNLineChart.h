...
@property (nonatomic) NSMutableArray *yChartLeftLabels;
@property (nonatomic) NSMutableArray *yChartRightLabels;//右边的数组
...
@property (nonatomic) NSInteger yLabelLeftNum;
@property (nonatomic) NSInteger yLabelRightNum;
